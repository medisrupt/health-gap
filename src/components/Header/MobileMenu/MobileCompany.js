...
import { solutions } from "../MenuCompany";
      ...
      <Popover className="">
        {({ open }) => (
          <>
            ...
            >
              <Popover.Panel className=" left-1/2 z-10  w-screen max-w-[300px]  transform  sm:px-0 lg:max-w-3xl">
                    ...
                    {solutions.map((item) => (
                      ...
                      >
                        ...
                        <div className="flex flex-col justify-between  w-full ml-2">
                          <p className=" flex w-full justify-between text-sm font-medium text-gray-900">
                            {item.name}
                            {/* <svg
